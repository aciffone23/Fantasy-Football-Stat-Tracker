...
function showModalInfo() {
    ...
    modal.innerHTML = `
        <div class="modal-content info-modal-content">
            ...
            <img src="https://github.com/aciffone23/Performance-Playbook/raw/main/imgs/names.gif" alt="Static Image" class="static-image">
            <p> You can click on the legend circles in the Season Stats graph to toggle the stats.</p>
            <img src="https://github.com/aciffone23/Performance-Playbook/raw/main/imgs/graph.gif" alt="Static Images" class="static-images">
